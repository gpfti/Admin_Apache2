...
|---------------|------------------------|------------------------------|-----------------------------|
| Palabra clave que inicia la regla | Expresión regular aplicada al URI solicitado (sin host) | Qué hacer si el patrón coincide: <br> - Modificación interna <br> - Ruta absoluta o URL <br> - Un guion (-) para no hacer nada | Opcional. Acciones especiales que controlan cómo se aplica la regla |
