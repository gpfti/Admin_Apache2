...
| -------------- | -------------- | ------------------ | ----------------- |
| Palabra clave obligatoria (Directiva). Inicia la regla de reescritura.  | Expresión regular que se compara con el URI solicitado      | Qué hacer si el patron coincide: Modificar el URI, Ruta interna, URL interna, Guion (-) = nada    | Opcional. Modifica|
