...
### 3. Instalar Tomcat (base común)

Descarga y descomprime Tomcat una vez:

```bash
cd /opt
wget https://dlcdn.apache.org/tomcat/tomcat-9/v9.0.85/bin/apache-tomcat-9.0.85.tar.gz
tar -xzf apache-tomcat-9.0.85.tar.gz
mv apache-tomcat-9.0.85 tomcat1
...
Si usaras AJP o SSL también, asegúrate de cambiar esos puertos para evitar conflictos.
...
Asumiendo que tu instancia actual está en `/opt/tomcat`:
...
## 2. Cambia los puertos en `tomcat2`
...
## 3. Asigna permisos de archivos al usuario tomcat2
