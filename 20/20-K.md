...
Aquí tienes una actividad práctica y didáctica para **probar el funcionamiento del interfaz de administración del balanceador en Apache2**, considerando que tanto el balanceador como los **dos servidores Apache Tomcat** están corriendo **en la misma máquina**. Los Tomcat responden en:
