...
| Resultado esperado                        | Configuración 1 | Configuración 2    |
| ----------------------------------------- | --------------- | ------------------ |
| Tiempo medio de respuesta                 | > 500 ms        | < 100 ms           |
| Fallos de conexión o errores 503          | Altos           | Cero o muy bajos   |
| Uso de CPU (`htop`)                       | 90–100%         | 40–70%             |
| Uso de RAM                                | Bajo            | Alto, pero estable |
| Capacidad de recuperación tras saturación | Lenta o fallida | Rápida             |
